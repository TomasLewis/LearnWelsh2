...
var Categories,sC,cV,dispLv,numTopics,myTopic,names=[],descriptions=[],displaynames=[],displayname,bw,bh,topicsJSON=jQuery.parseJSON(topicsENprimary),firstScreen,firstView;
...
$("#forwardArra,#backwardArra").on("touchstart",function(){$(this).find("#bgFill").css("fill","red")}).on("touchend",function(){$(this).find("#bgFill").css("fill","black")}),
...
$("#content").off().on("click","div[class=greenTopSign]",function(){clickS.play(),myTopic=$(this).attr("name"),displayname=$(this).attr("title"),
